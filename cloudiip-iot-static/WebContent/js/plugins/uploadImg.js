function DragImgUpload(id,options) {
    ...
    this.preview = $('<div id="preview"><img src='+imgUrlNone+' class="img-responsive"  style="width: 100%;height: 100%;" alt="" title=""> </div>');
    this.opts=$.extend(true, defaultOpt,{
    }, options);
    this.delete=$('<div class="deleteImg"><i class="fa fa-trash-o"></i></div>');
    this.init();
...
DragImgUpload.prototype = {
    ...
    eventClickInit:function () {
       ...
       /*  this.me.unbind().click(function () {
        ...
        $(".build-img .btn.upload").unbind().click(function () {
            self.createImageUploadDialog();
        })
        var dp = this.me[0];
